<%@ Page Title="" Language="C#" MasterPageFile="~/collegemaster.master" AutoEventWireup="true" CodeBehind="studentreg.aspx.cs" Inherits="intercollege.studentreg1" %>
...
&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td class="style2">
                    &nbsp;</td>
                <td>
                    <asp:Button ID="btnsubmit" runat="server" Text="Submit" ValidationGroup="reg" BackColor="#26A718" 
                        Font-Bold="True" ForeColor="White" Height="30px" Width="100px" 
                        onclick="btnsubmit_Click" OnClientClick="validateRB()" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <asp:Button ID="btncancle" runat="server" Text="cancel" BackColor="#26A718" 
                        Font-Bold="True" ForeColor="White" Height="30px" Width="100px" 
