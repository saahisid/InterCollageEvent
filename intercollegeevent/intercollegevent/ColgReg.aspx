<%@ Page Title="" Language="C#" MasterPageFile="~/collegeevent.Master" AutoEventWireup="true" CodeBehind="ColgReg.aspx.cs" Inherits="intercollege.ColgReg" %>
            ...
            <tr>
                ...
                <td  colspan="4" align="center">
                    <asp:Button ID="btnsubmit" runat="server" Text="Submit" 
                        onclick="btnsubmit_Click" ValidationGroup="reg" BackColor="#5875B1" 
                        Font-Bold="True" ForeColor="White" Height="30px" Width="100px" />
&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btncancel" runat="server" Text="Cancel" 
                        onclick="btncancel_Click" BackColor="#5875B1" Font-Bold="True" 
