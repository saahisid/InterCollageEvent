<%@ Page Title="" Language="C#" MasterPageFile="~/collegeevent.Master" AutoEventWireup="true" CodeBehind="colg_master.aspx.cs" Inherits="intercollege.colg_master" %>
...
&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
            ...
            <td style="height: 59px"> <asp:Button ID="btnadd" runat="server" Text="Add" onclick="btnadd_Click1" BackColor="#5875B1" 
