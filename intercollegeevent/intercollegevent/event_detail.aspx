<%@ Page Title="" Language="C#" MasterPageFile="~/collegeevent.Master" AutoEventWireup="true" CodeBehind="event_detail.aspx.cs" Inherits="intercollege.event_detail" %>
        ...
        <tr>
            ...
            <td>
                &nbsp;<asp:Button ID="btnsubmit" runat="server" Text="SUBMIT" 
                    onclick="btnsubmit_Click" BackColor="#5875B1" class="form-control"
