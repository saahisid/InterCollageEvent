<%@ Page Title="" Language="C#" MasterPageFile="~/collegeevent.Master" AutoEventWireup="true" CodeBehind="manageCourse.aspx.cs" Inherits="intercollege.manageCourse" %>
...
&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
            ...
            <tr>
                ...
                <td style="height: 45px"> <asp:Button ID="btnadd" runat="server" Text="Add" 
                        onclick="btnadd_Click1" BackColor="#5875B1" 
