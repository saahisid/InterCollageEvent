<%@ Page Title="" Language="C#" MasterPageFile="~/collegeevent.Master" AutoEventWireup="true" CodeBehind="postcandidate.aspx.cs" Inherits="intercollege.postcandidate" %>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnsubmit" runat="server" Text="submit" 
                        onclick="btnsubmit_Click" BackColor="#5875B1" 
                        Font-Bold="True" ForeColor="White" Height="30px" Width="100px"  />
&nbsp;&nbsp;
                    <asp:Button ID="btncancel" runat="server" Text="Cancel" BackColor="#5875B1" 
                        Font-Bold="True" ForeColor="White" Height="30px" Width="100px" />
                </td>
            </tr>
        </table>
